...
class Save_menu:
    ...
    def click(self, mouse_pos, mouse_button):
        if self.from_where == 'editor':
            if self.buttons.level1_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0]:  # left mouse click
                    self.buttons.save1 = datetime.now().strftime("%y-%m-%d %H:%M:%S")
                    self.buttons.saved1 = True
                    self.save_file('level1')
                if mouse_button[2]:  # right click
                    self.buttons.saved1 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level1.json'))
            elif self.buttons.level2_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0]:  # left mouse click
                    self.buttons.save2 = datetime.now().strftime("%y-%m-%d %H:%M:%S")
                    self.buttons.saved2 = True
                    self.save_file('level2')
                if mouse_button[2]:  # right click
                    self.buttons.saved2 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level2.json'))
            elif self.buttons.level3_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0]:  # left mouse click
                    self.buttons.save3 = datetime.now().strftime("%y-%m-%d %H:%M:%S")
                    self.buttons.saved3 = True
                    self.save_file('level3')
                if mouse_button[2]:  # right click
                    self.buttons.saved3 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level3.json'))
            elif self.buttons.level4_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0]:  # left mouse click
                    self.buttons.save4 = datetime.now().strftime("%y-%m-%d %H:%M:%S")
                    self.buttons.saved4 = True
                    self.save_file('level4')
                if mouse_button[2]:  # right click
                    self.buttons.saved4 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level4.json'))
            elif self.buttons.level5_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0]:  # left mouse click
                    self.buttons.save5 = datetime.now().strftime("%y-%m-%d %H:%M:%S")
                    self.buttons.saved5 = True
                    self.save_file('level5')
                if mouse_button[2]:  # right click
                    self.buttons.saved5 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level5.json'))
            elif self.buttons.level6_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0]:  # left mouse click
                    self.buttons.save6 = datetime.now().strftime("%y-%m-%d %H:%M:%S")
                    self.buttons.saved6 = True
                    self.save_file('level6')
                if mouse_button[2]:  # right click
                    self.buttons.saved6 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level6.json'))
        if self.from_where == 'main_menu':
            if self.buttons.level1_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0] and self.buttons.saved1:  # left mouse click
                    self.switch_locker = False
                    self.switch({'from': 'save_menu', 'to': 'level'}, self.read_level('level1'))
                if mouse_button[2]:  # right click
                    self.buttons.saved1 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level1.json'))
            elif self.buttons.level2_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0] and self.buttons.saved2:  # left mouse click
                    self.switch_locker = False
                    self.switch({'from': 'save_menu', 'to': 'level'}, self.read_level('level2'))
                if mouse_button[2]:  # right click
                    self.buttons.saved3 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level3.json'))
            elif self.buttons.level3_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0] and self.buttons.saved3:  # left mouse click
                    self.switch_locker = False
                    self.switch({'from': 'save_menu', 'to': 'level'}, self.read_level('level3'))
                if mouse_button[2]:  # right click
                    self.buttons.saved3 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level3.json'))
            elif self.buttons.level4_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0] and self.buttons.saved4:  # left mouse click
                    self.switch_locker = False
                    self.switch({'from': 'save_menu', 'to': 'level'}, self.read_level('level4'))
                if mouse_button[2]:  # right click
                    self.buttons.saved4 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level4.json'))
            elif self.buttons.level5_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0] and self.buttons.saved5:  # left mouse click
                    self.switch_locker = False
                    self.switch({'from': 'save_menu', 'to': 'level'}, self.read_level('level5'))
                if mouse_button[2]:  # right click
                    self.buttons.saved5 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level5.json'))
            elif self.buttons.level6_save_button_rect.collidepoint(mouse_pos):
                if mouse_button[0] and self.buttons.saved6:  # left mouse click
                    self.switch_locker = False
                    self.switch({'from': 'save_menu', 'to': 'level'}, self.read_level('level6'))
                if mouse_button[2]:  # right click
                    self.buttons.saved6 = False
                    os.remove(path.join(script_directory, 'saved_levels', f'level6.json'))
        self.save_button_states()
